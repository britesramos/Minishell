...
/*   Updated: 2024/10/16 14:05:46 by mstencel      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_cd_dir(char *path, t_data *data)
{
	char	*old_cwd;
	char	*cwd;
...
void	ft_chdir_error(char *path, t_data *data)
{
	int		oops;
	char	*cwd;
...
void	ft_cd_key(t_data *data, char *key)
{
	char *path;
...
void	ft_cd(char **cmd, t_data *data)
{
	...
	if (!cmd[1] || ft_strncmp(cmd[1], "~", 2) == 0 || ft_strncmp(cmd[1], "#", 2) == 0)
		ft_cd_key(data, "HOME");
